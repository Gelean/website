...
# # Convert the bucket policy from JSON dict to string
...
# # Check if bucket already exists and skip creating if it's found
# bucket_exists = False
...
#         s3_client.put_public_access_block(Bucket=bucket_name, PublicAccessBlockConfiguration={'BlockPublicAcls': False, 'IgnorePublicAcls': False, 'BlockPublicPolicy': False, 'RestrictPublicBuckets': False})
#         s3_client.put_bucket_policy(Bucket=bucket_name, Policy=bucket_policy)
#         s3_client.put_bucket_cors(Bucket=bucket_name, CORSConfiguration=cors_configuration)
#         s3_client.put_bucket_website(Bucket=bucket_name, WebsiteConfiguration={'ErrorDocument': {'Key': 'home.html'}, 'IndexDocument': {'Suffix': 'home.html'}})
